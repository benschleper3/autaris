  ...
  return (
    <Card className="p-3 sm:p-4 lg:p-6 border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-autaris-primary/20 hover:bg-card/80 cursor-pointer">
      <div className="flex items-start sm:items-center justify-between mb-3 sm:mb-4 gap-2">
        ...
        <Badge className="bg-autaris-success/10 text-autaris-success border-autaris-success/20 text-xs flex-shrink-0">
          New Report
        </Badge>
      </div>

      <div className="space-y-3 sm:space-y-4">
        <div className="p-3 sm:p-4 rounded-lg bg-gradient-to-r from-autaris-primary/10 to-autaris-secondary/10 border border-autaris-primary/20">
        ...
        <div className="space-y-2 sm:space-y-3">
          <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm">
            <Clock className="w-3 h-3 sm:w-4 sm:h-4 text-autaris-secondary flex-shrink-0" />
          ...
          <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm">
            <TrendingUp className="w-3 h-3 sm:w-4 sm:h-4 text-autaris-success flex-shrink-0" />
          ...
          <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm">
            <Calendar className="w-3 h-3 sm:w-4 sm:h-4 text-autaris-accent flex-shrink-0" />
        ...
        <div className="pt-3 sm:pt-4 border-t border-border/30">
          <Button className="w-full bg-autaris-primary hover:bg-autaris-primary-light text-sm">
            View Full Report
          </Button>
        </div>
      </div>
